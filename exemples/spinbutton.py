...
<div class="article">
		...
		<p>Désolée, vous ne semblez pas trouver la bonne page.</p>
    <p>Vous pouvez peut-être retrouver dans le menu de droite la page que vous cherchez.<br /></p>
   ...
   <h2>Python</h2>
    ...
    <h2>Slackware</h2>
		<ul>
			...
			<li><a href="../slackware/partage.php">Partage NFS</a></li>
